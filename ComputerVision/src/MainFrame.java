//Edited for our use by: Felix Lawson
...
public class MainFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        subscriptionKeyTextField.setText(key);

        subscriptionTextRegionLabel.setText("Subscription Region:");

        subscriptionRegionComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] {region}));
    ...
    private void analyzeImageButtonActionPerformed(String imagelink, FileOutputStream out) {
        // Analyze the image.
        JSONObject jsonObj = AnalyzeImage(imagelink);
        ...
        try{
            String data = jsonObj.toString(2);
    ...
    public static void main(String args[]) {
        ...
        if(args.length != 2)
        {
            System.out.append("ERROR: You need to pass in the key and the region");
            System.exit(0);
        }
        key = args[0];
        region = args[1];
        ...
        try{
            FileOutputStream out = new FileOutputStream("./TheWayYouNibbleOnMyEarTheOnlyWordsIWannaHear.txt");
            //put in file name
            reader = new BufferedReader(new FileReader("./ImageSource.txt"));
            out.write(header.getBytes());
            String image = reader.readLine();
            while(image != null)
            {
                MainFrame analyze = new MainFrame();
                analyze.analyzeImageButtonActionPerformed(image, out);
